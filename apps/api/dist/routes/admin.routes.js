...
import { getDashboard, getUsers, getApplications, reviewApplication, updateUserRole, suspendUser, deleteUser, listAllCourses, getCoursesForReview, moderateCourse, toggleFeatured, deleteCourse, unpublishCourse, getFlaggedReviews, moderateReview, deleteReview, getUserById, getReviewsModeration, getQuestionsModeration, getCoupons, createCoupon, updateCoupon, deleteCoupon, getRefunds, approveRefund, rejectRefund, getRevenue, getBroadcasts, sendBroadcast, getSettings, updateSettings, getCategories, createCategory, updateCategory, deleteCategory } from '../controllers/admin.controller';
import { getHomepageSections, updateHomepageSection, reorderHomepageSections, listPages, getPage, createPage, updatePage, deletePage, getAuditLogs } from '../controllers/cms.controller';
const router = Router();
